<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminRegister.aspx.cs" Inherits="BookStoreApp.WebForms.AdminRegister" %>
...
<body style="background-color: lightgrey">
    <form id="form1" runat="server">
        ...
        <div class="container">
            <p class="text-Danger text-left" style="font-size: 60px">Admin Register</p>
            ...
            <div style="margin-top: 7px" class="input-group mb-3 w-50">
                ...
                <asp:TextBox class="form-control" ID="ConfirnPasswordTextBox" TextMode="Password" runat="server" placeholder="Confirm Password"></asp:TextBox>
            </div>
