    ...
    public partial class AdminDashBoard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (allbookdata.MoveNext())
            {
                ...
                string data = "<div class='card' title='" + description + "' style='width: 16rem; margin-right: 8px; margin-bottom: 15px; border-color: #dc3545'>" +
                     "<img src='" + image + "' style='width: 100px; height: 155px; margin-left: 33%; margin-top: 10px;' class='card-img-top' alt='' />" +
                    "<div class='card-body'>" +
