namespace Algorithm
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("5-MergeSortAlgorithm       6-Prime0To1000        7-RegexPattern         8-StringPermutation          9-primePalindromeAnagram");
           int ch = int.Parse(Console.ReadLine());
            switch(ch)
            {
                ...
                case 8: StringPermutationRecursion.DriverMethodPermutation();
                    break;
                case 9: PrimePalindromeAnagram.DriverPrimePalindromeAnagram();
                    break;
